...
# Decisions: {short title of solved problem and solution}
...
define when/how this decision should be realized and if/when it should be
re-visited. Links to other decisions and resources might appear here as
well.}
